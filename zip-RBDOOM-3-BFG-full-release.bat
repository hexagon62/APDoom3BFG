set filename=RBDOOM-3-BFG-1.6.0.x-full-win64-yyyymmdd-git-xxxxxxx.7z
copy RBDOOM-3-BFG-1.6.0.x-lite-win64-yyyymmdd-git-xxxxxxx.7z %filename%
...
7z a %filename% base/_rbdoom_global_illumination_data.pk4
